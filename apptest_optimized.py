...
# ==================== 2. 主程式邏輯 ====================
def main():
    st.title("📊 交易數據分析系統 v2.5 效能優化版")
    st.markdown("**⚡ 向量化運算 | 記憶體優化 | 快取機制 | 大數據處理加速**")
    ...
    if not uploaded_files:
        ...
        1. **向量化運算**: 使用 NumPy/Pandas groupby 替代循環,速度提升 10-50 倍
...
- 📦 白框 = IQR 區間
    ...
    with tab2:
        ...
        selected_aid = st.text_input(
            ...
            help="從 Tab 1 英雄榜複製 AID 貼上即可"
        )

        if selected_aid:
            with st.spinner("載入客戶資料..."):
